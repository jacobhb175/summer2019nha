...
$(".nextYear").click(function () {
    ...
    switch (season) {
        case "Spring":
            ...
            break;
        case "Summer":
            //1/10 chance of summer to fall, 1/10 chance of summer straight to winter
            ...
            if (x == 0) {
                ...
                season = "Winter";
                //Alert of seasonal change
                alert("A white raven from the citadel has arrived at the castle of your local lord. The seasons are changing. Summer is sadly over and winter is coming.");
            }
            break;
        case "Fall":
            //Fall to winter
            ...
            break;
        case "Winter":
            //1/4 chance of winter to spring, 1/8 chance of winter straight to summer
            ...
            if (y <= 1) {
                ...
                season = "Summer";
                //Alert of seasonal change
                alert("A white raven from the citadel has arrived at the castle of your local lord. The seasons are changing. Winter is over and summer is coming at last.");
            }
    }
