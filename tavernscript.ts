...
let blackJackQ = prompt("Harry: Well, want to play some cards in the meantime? (Respond yes or no)");
...
//Continuing the convo if you say no
    ...
    console.log("no");
    let drunkQ = prompt("Harry: Well, want some drinks? First one's on the house for you, each extra one is 3 stars.");

    //Asking how many drinks you want if you say yes
    if(drunkQ == "yes") {
    	let beerNum = prompt("Harry: How many?") -1 +1;
    	console.log(beerNum);
